...
<head>
    ...
    <link rel="stylesheet" href="css/calculadora.css"><!-- se agrega toda la linea para llamar a css -->
    <!--CND BOOTSTARP-->
    ...
    <div class="main-frame-cal">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="n2" class="form-control" id="exampleFormControlInput2" placeholder="Digite Número 2"> <!-- se agrega el nombre name  y letra mayuscula-->
            </div>
            <div class="form-group">
